(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('chalk'), require('os'), require('tty'), require('envinfo'), require('node-fetch'), require('path'), require('pkg-up'), require('fs')) :
  typeof define === 'function' && define.amd ? define(['exports', 'chalk', 'os', 'tty', 'envinfo', 'node-fetch', 'path', 'pkg-up', 'fs'], factory) :
  (global = global || self, factory(global.epicfail = {}, global.chalk, global.os, global.tty, global.envinfo, global.nodeFetch, global.path, global.pkgUp, global.fs));
}(this, (function (exports, chalk, os, tty, envinfo, fetch, path, pkgUp, fs) {
  function _interopDefaultLegacy (e) { return e && typeof e === 'object' && 'default' in e ? e : { 'default': e }; }

  var chalk__default = /*#__PURE__*/_interopDefaultLegacy(chalk);
  var os__default = /*#__PURE__*/_interopDefaultLegacy(os);
  var tty__default = /*#__PURE__*/_interopDefaultLegacy(tty);
  var envinfo__default = /*#__PURE__*/_interopDefaultLegacy(envinfo);
  ...
  async function genEnv(envinfo, pkg) {
    ...
    const res = [];
    res.push(makeTitle(chalk__default['default'].green, "Environment"));
    ...
    return chalk__default['default'].green(res.join("\n"));
  }
  ...
  async function findIssues(q, repo) {
    ...
    try {
      const res = await fetch__default['default'](`https://api.github.com/search/issues?q=${encodeURIComponent(query)}&per_page=3`).then(res => res.json());
  ...
  function getModulePackagePath(caller) {
    return pkgUp__default['default'].sync({
  ...
  function renderError(err) {
    ...
    return (title !== "Error" ? makeTitle(chalk__default['default'].red, title) + "\n" : "") + chalk__default['default'].red(err.message);
  }

  function renderStacktrace(stack) {
    return chalk__default['default'].gray(`
\`\`\`
${stack}
\`\`\``);
  }
  ...
  async function renderIssues(message, repo) {
    ...
    if (issues && issues.length > 0) {
      res.push("\n" + makeTitle(chalk__default['default'].white, "Issues"));
      res.push(issues.map(issue => `${chalk__default['default'].green(`#${issue.number}`)} ${issue.title}`).join("\n"));
    }
  ...
  function renderBugTracker(reporterURL, stash, repo, eventID) {
    ...
    return `\nIf you think this is a bug, please report at ${terminalLink(chalk__default['default'].yellow(reporterURL), detailedURL, {
    fallback: false
  })} along with the information above${eventID ? ` and event id ${chalk__default['default'].bold.magenta(eventID)}` : ""}.`;
  }

  exports.EpicfailError = EpicfailError;
  exports.epicfail = epicfail;
  exports.fail = fail;
